...
extension EventBodyExtension on List<data.Event> {
  List<Widget> asCompactEventList(BuildContext context) =>
      select((x, index) => StatefulBuilder(builder: (context, setState) {
                ...
                itemBuilder: (context) => [
                      ...
                      if (x.isOwnEvent)
                        AdaptiveMenuItem(
                          ...
                          onTap: () {
                            setState(() => Share.session.customEvents.remove(x));
                            Share.settings.save();
                            Navigator.of(context).pop();
                          },
                        ),
  ...
  List<Widget> asCompactHomeworkList(BuildContext context) => select((x, index) => AdaptiveMenuButton(
      longPressOnly: true,
      itemBuilder: (context) => [
            AdaptiveMenuItem(
              onTap: () {
                        ...
                        Row(
                          children: [
                            ...
                            Align(
                                ...
                                child: Visibility(
                                  visible: x.done,
                                  child: Container(margin: EdgeInsets.only(left: 5), child: Icon(CupertinoIcons.check_mark)),
                                ))
                          ],
                        ),
                        Visibility(
...
extension GradeBodyExtension on List<({List<Grade> grades, Lesson lesson})> {
  List<Widget> asCompactGradeList(BuildContext context) => select((x, index) => AdaptiveMenuButton(
      longPressOnly: true,
      itemBuilder: (context) => [
            AdaptiveMenuItem(
              onTap: () {
