...
class _GradeComposePageState extends State<GradeComposePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return SearchableSliverNavigationBar(
      ...
      largeTitle: nameController.text.isEmpty
          ? Text('New custom grade')
          : Text(nameController.text, maxLines: 1, overflow: TextOverflow.ellipsis),
                                    ...
                                    Container(
                                      ...
                                      child: GestureDetector(
                                          ...
                                          child: Opacity(
                                              ...
                                              child: Container(
                                                  margin: EdgeInsets.only(top: 5, bottom: 5),
                                                  child: Text(switch (semester) { 1 => "first", 2 => "second", _ => "ERR" },
                                                      style: TextStyle(fontWeight: FontWeight.w600))))),
                                    )
                                  ]),
                              // Message input
                                                    ...
                                                    children: [
                                                      ...
                                                      CupertinoFormRow(
                                                          ...
                                                          child: CupertinoSwitch(
                                                              value: counts, onChanged: (s) => setState(() => counts = s))),
                                                      // Resit
                                                      CupertinoFormRow(
                                                          prefix: Flexible(
                                                              flex: 3,
